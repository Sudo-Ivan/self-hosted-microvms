...
load_template() {
	...
	TEMPLATE_SUGGESTED_PROFILE=""
	TEMPLATE_SECRETS_KEYS=""
	TEMPLATE_EXAMPLE_SHARE=""
	TEMPLATE_FIRST_BOOT_HINT=""
	...
	unset DESCRIPTION PORT_FORWARDS PACKAGES HEALTH_PATH HEALTH_PORT HEALTH_SCHEME \
		...
		DATA_SIZE_MIB ROOTFS_SIZE_MIB SUGGESTED_PROFILE SECRETS_KEYS EXAMPLE_SHARE \
		FIRST_BOOT_HINT
	...
	TEMPLATE_SUGGESTED_PROFILE="${SUGGESTED_PROFILE:-${TEMPLATE_SUGGESTED_PROFILE}}"
	TEMPLATE_SECRETS_KEYS="${SECRETS_KEYS:-${TEMPLATE_SECRETS_KEYS}}"
	TEMPLATE_EXAMPLE_SHARE="${EXAMPLE_SHARE:-${TEMPLATE_EXAMPLE_SHARE}}"
	TEMPLATE_FIRST_BOOT_HINT="${FIRST_BOOT_HINT:-${TEMPLATE_FIRST_BOOT_HINT}}"
}
